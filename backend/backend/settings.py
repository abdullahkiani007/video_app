...
SECRET_KEY = 'django-insecure-hr8380maeyubn47pk0-*h3wszn4g)(vc_-3uz_#uzv-71ydyn='
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            # 'hosts': [('127.0.0.1', 6379)],  # Use 'redis' as hostname in Docker
            'hosts': [('redis', 6379)],  # Using the service name from docker-compose
        },
    },
}
